OutFile "BitTornado-0.3.17-w32install.exe"
...
DirText "Setup will install BitTornado 0.3.17 in the following folder.$\r$\n$\r$\nTo install in a different folder, click Browse and select another folder."
...
Section -Post
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BitTornado" "DisplayName" "BitTornado 0.3.17"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BitTornado" "DisplayVersion" "0.3.17"
...
Function un.onUninstSuccess
  HideWindow
  MessageBox MB_ICONINFORMATION|MB_OK "BitTornado 0.3.17 was successfully removed from your computer."
FunctionEnd

Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Are you sure you want to completely remove BitTornado 0.3.17 and all of its components?" IDYES +2
  Abort
FunctionEnd
